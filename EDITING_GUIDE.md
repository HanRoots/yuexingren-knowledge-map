...
2. 点击筛选栏中的“编辑内容”。
3. 找到目标书目，点击“编辑此书”。
4. 修改书名、本级序号、学识目标、学识主题、价值观、能力目标或书籍类型。
5. 点击“保存修改”。
...
“学识主题”默认根据学识目标自动识别。关闭“根据学识目标自动识别”后，可以手动选择一个或多个主题；重新勾选即可恢复自动识别。

## 新增与删除书目

- 新增：进入编辑模式后点击“新增书目”，选择 L1-L6 级别和插入序号，填写书名、三大目标、学识主题与书籍类型，再点击“保存新书”。
